...
$query = "SELECT * FROM sanpham WHERE ID_LOAITS = 'DC01'";
...
<body>
    ...
    <div class="new-collection-head-bg">
        <img class="dt-width-100" src="./images/bg-daychuyen.jpg" alt="Daychuyen Image">
        <a href="index.php" class="section-title">
                <span>Trang chủ</span> / Dây Chuyền
            </a>
        <h2 class="items-heading">Dây chuyền</h2>
    </div>
    <div class="container">
        <div class="products">
		<?php
