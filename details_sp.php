    ...
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        ...
        <div class="text-center">
          <img src="images/<?= $vphoto; ?>" width="300" class="img-thumbnail">
        </div>
        <h4 class="text-light">Tên trang sức : <?= $vname; ?></h4>
        <h4 class="text-light">Nhà cung cấp : <?= $vid_ncc; ?></h4>
        <h4 class="text-light">Gía : <?= $vgia; ?></h4>
        <h4 class="text-light">Loại trang sức : <?= $vid_loaits; ?></h4>
        <h4 class="text-light">Bảo hành : <?= $vbaohanh; ?></h4>
        <h4 class="text-light">Mô tả : <?= $vmota; ?></h4>
        <h4 class="text-light">Tình trạng : <?= $vtinhtrang; ?></h4>
      </div>
    </div>
  </div>
    </body>
