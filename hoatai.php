...
$query = "SELECT * FROM sanpham WHERE ID_LOAITS = 'BT01'";
...
<body>
    ...
    <div class="new-collection-head-bg">
        <img class="dt-width-100" src="./images/bg-hoatai.jpg" alt="Hoatai Image">
        <a href="index.php" class="section-title">
                <span>Trang chủ</span> / Hoa tai
            </a>
        <h2 class="items-heading">Hoa tai</h2>
    </div>
    <div class="container">
        <div class="products">
		<?php
