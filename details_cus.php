...
<body>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        <h4 class="text-light">ID khách hàng : <?= $vid_cus; ?></h4>
        <h4 class="text-light">Tên : <?= $vfirst_name; ?></h4>
        <h4 class="text-light">Họ : <?= $vlast_name; ?></h4>
        <h4 class="text-light">Giới tính: <?= $vgt == 0 ? 'Nam' : 'Nữ'; ?></h4>
        <h4 class="text-light">Email : <?= $vemail_cus; ?></h4>
        <h4 class="text-light">Địa chỉ : <?= $vadd_cus; ?></h4>
        <h4 class="text-light">SĐT: <?= $vphone_cus; ?></h4>
      </div>
    </div>
  </div>
    </body>
