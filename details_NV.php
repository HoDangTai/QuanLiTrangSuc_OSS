...
<body>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        <h4 class="text-light">ID nhân viên: <?= $vid_emp; ?></h4>
        <h4 class="text-light">Phòng ban: <?= $ten_phongban; ?></h4>
        <h4 class="text-light">Vị trí: <?= $ten_vitri; ?></h4>
        <h4 class="text-light">Họ : <?= $vfirstname_emp; ?></h4>
        <h4 class="text-light">Tên : <?= $vlastname_emp; ?></h4>
        <h4 class="text-light">Giới tính: <?= $vgt == 0 ? 'Nam' : 'Nữ'; ?></h4>
        <h4 class="text-light">Email : <?= $vemail_emp; ?></h4>
        <h4 class="text-light">Địa chỉ : <?= $vadd_emp; ?></h4>
        <h4 class="text-light">SĐT: <?= $vphone_emp; ?></h4>
        <h4 class="text-light">Quyền: <?= $vquyen; ?></h4>
      </div>
    </div>
  </div>
    </body>
