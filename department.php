...
<body>
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <h3 class="text-center text-dark mt-2">Danh sách các phòng ban</h3>
        <hr>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="action_dep.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <input type="text" name="id_dep" value="<?= $id_dep; ?>" class="form-control" placeholder="Nhập ID phòng ban" 
            <?php if ($id_dep) echo 'readonly'; ?> required>
        </div>
          <div class="form-group">
            <input type="text" name="tenphongban" value="<?= $tenphongban; ?>" class="form-control" placeholder="Nhập tên loại trang sức" required>
          </div>
          <div class="form-group">
            <?php if ($id_dep == true) { ?>
      ...
      <div class="col-md-8">
        ...
        ?>
        <h3 class="text-center text-info">Các phòng ban có sẵn trong cơ sở dữ liệu</h3>
        <table class="table table-hover" id="data-table">
          ...
          <tbody>
            ...
            <tr class="text-center">
              ...
              <td>
                <a href="details_dep.php?details=<?= $row['ID_DEP']; ?>" class="badge badge-primary p-2">Xem chi tiết</a> |
                <a href="action_dep.php?delete=<?= $row['ID_DEP']; ?>" class="badge badge-danger p-2" onclick="return confirm('Bạn có chắc là muốn xóa?');">Xóa</a> |
                <a href="department.php?edit=<?= $row['ID_DEP']; ?>" class="badge badge-success p-2">Chỉnh sửa</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
