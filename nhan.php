...
$query = "SELECT * FROM sanpham WHERE ID_LOAITS = 'N01'";
...
<body>
    ...
    <div class="new-collection-head-bg">
        <img class="dt-width-100" src="./images/bg-nhan.jpg" alt="Nhan Image">
            <a href="index.php" class="section-title">
                <span>Trang chủ</span> / Nhẫn
            </a>
        <h2 class="items-heading">Nhẫn</h2>
    </div>
    <div class="container">
        <div class="products">
		<?php
